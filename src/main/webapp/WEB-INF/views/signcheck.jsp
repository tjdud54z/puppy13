    ...
    <div class="container sub-layout">
        ...
        <div class="join-agree-layout">
            <div class="jumbotron" align="center">
                <h1>M.A.T</h1>
                <hr>
                <p><b>회원가입 약관 및 개인정보 처리방침 안내 동의</b></p>
            </div>
            <div class="row" align="left">
                <div class="col-sm-6" style="margin: 0 auto;">
                    <form name='nJoin' role="form" id="joinForm" method="post" action="/puppy13/sign.do" autocomplete="off" onSubmit="return check()">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <div class="form-group align-middle">
                                    <label class="control-label"><b>1. 회원가입 약관</b></label>
                                    <div class="col-xs-12">
                                        <textarea class="form-control" readonly rows="20" cols="100">제1조(목적)
                                    ...
                                    <div class="col-xs-12">
                                        <div class="checkbox pull-right">
                                            <label for="join_user_agree">
                                                <input type="checkbox" name="join_user_agree" id="join_user_agree" value="1" /> 회원가입 약관에 동의합니다.
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group pull-left">
                                    <label class="control-label"><b>2. 개인정보 처리방침 안내</b></label>
                                    <div class="col-xs-12">
                                        <textarea class="form-control" readonly rows="20" cols="100">
<회사>('사이트 URL'이하 '사이트명')은(는) 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.
...
①이 개인정보처리방침은 시행일로부터 적용되며, 법령 및 방침에 따른 변경내용의 추가, 삭제 및 정정이 있는 경우에는 변경사항의 시행 7일 전부터 공지사항을 통하여 고지할 것입니다.
                                    ...
                                    <div class="col-xs-12">
                                        <div class="checkbox pull-right">
                                            <label for="join_priv_agree">
                                                <input type="checkbox" name="join_priv_agree" id="join_priv_agree" value="1" /> 개인정보 처리방침에 동의합니다.
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="panel-footer">
                                ...
                                <div style="overflow: hidden">
                                    <div class="col-sm-offset-3 col-sm-6" style="margin: 0 auto;">
                                        <a href="Join_Sign_up.jsp" style="color: white;">
                                            <button class="btn btn-lg btn-primary btn-block" type="submit">가입 진행</button><br>
                                        </a>
                                    </div>
                                </div>
                            </div>
