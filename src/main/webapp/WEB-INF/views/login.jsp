...
<body>
    <!-- Top -->
    <div class="div1">
        <br><a href="/puppy13/index.do"><img alt="이미지업음" src="resources/image/puppy3.gif" width="200px" height="200px"></a><br><br>
    </div>

    <!-- Middle -->
    <div class="card align-middle" style="width:20rem; border-radius:20px; margin:0 auto;">
        <div class="card-title" style="margin-top:30px;">
            <h2 class="card-title text-center" style="color:#113366;">M.A.T 로그인</h2>
        </div>
        <div class="card-body">
            <form class="form-signin" name="frmLoing">
                ...
                <a href="/puppy13/signcheck.do">회원이 아니신가요?</a>

                <button id="btnLogin" class="btn btn-lg btn-primary btn-block" type="button">로 그 인</button>
                <c:if test="${msg=='failure' }">
                    <div style="color: red">아이디 또는 비밀번호가 틀리거나 탈퇴한 회원입니다.</div>
                </c:if>
<%--                 <c:if test="${msg=='out' }">
                    <div style="color: red">탈퇴한 회원입니다.</div>
                </c:if> --%>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#btnLogin").click(function() {
                ...
                document.frmLoing.action = "/puppy13/loginCheck.do";
