						...
						<c:forEach items="${list}" var = "list">
							<tr>
								<c:if test="${list.del_gb == 'N'}">
									...
									<td><a href="/puppy13/board/readView.do?bno=${list.bno}&page=${scri.page}&perPageNum=${scri.perPageNum}&searchType=${scri.searchType}&keyword=${scri.keyword}"><c:out value="${list.title}" /></a></td>
