    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
				...
				<h1 align=" ">M.A.T 게시판</h1>
                    <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <div class="container">
                    
                    <section id="container">
				<form name="writeForm" method="post" action="/puppy13/board/write.do" enctype="multipart/form-data">
					<table>
						<tbody>
								<tr>
									<td>
										<label for="title"><b>제목</b></label><br>
										<input style="width: 500px;" class="form-control" type="text" id="title" name="title" class="chk" title="제목을 입력하세요."/>
									</td>
								</tr>	
								<tr>
									<td>
										<label for="content"><b>내용</b></label><br>
										<textarea style="width: 500px; height: 300px;" class="form-control" id="content" name="content" class="chk" title="내용을 입력하세요."></textarea>
									</td>
								</tr>
								<tr>
									<td>
										<label for="writer"><b>작성자</b></label><br>
										<input style="width: 500px;" class="form-control" type="text" id="writer" name="writer" class="chk" title="작성자를 입력하세요." value="${nickname}" readonly="readonly"/>
									</td>
								</tr>
								<tr>
								<tr>
								...
								<tr>
									<td><br>					
										<button class="write_btn btn btn-info" type="submit">작성</button>	
            ...
            <script src="js/demo/chart-pie-demo.js"></script>
						...
						$(document).ready(function(){
							...
							$(".write_btn").on("click", function(){
								...
								formObj.attr("action", "/puppy13/board/write.do");
						...
						function fn_addFile(){
							...
							$(".fileAdd_btn").on("click", function(){
								$("#fileIndex").append("<div><br><input type='file' style='float:left;' name='file_"+(fileIndex++)+"'>"+"</button>"+"<button class='btn btn-danger btn-sm' type='button' style='float:right;' id='fileDelBtn'>"+"삭제"+"</button></div>");
							});
