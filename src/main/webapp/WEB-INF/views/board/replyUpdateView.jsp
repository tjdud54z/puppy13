    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
				...
				<h1 align="left">M.A.T 게시판> 글 상세> 댓글 수정</h1>
                    <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <div class="container">
                    
				<section id="container">
				<form name="updateForm" role="form" method="post" action="/puppy13/board/replyUpdate.do">
					...
					<table>
						<tbody>
							<tr>
								<td>
									<b>댓글 작성자</b>  : ${nickname}(${id})
									<br><br>
									<label for="content">
										<b>댓글 내용</b>
									</label>
									<textarea style="width: 500px; height: 200px;" id="content" name="content" class="form-control">${replyUpdate.content}</textarea>
								</td>
							</tr>	
			...
			$(document).ready(function(){
				...
				$(".cancel_btn").on("click", function(){
					location.href = "/puppy13/board/readView.do?bno=${replyUpdate.bno}"
						   + "&page=${scri.page}"
