...
public class BoardServiceImpl implements BoardService {
	...
	//게시물 회원 삭제
	   ...
	   @Override
	   public int userdelboard(BoardVO boardVO) throws DataAccessException {
		   
	      return dao.userdelboard(boardVO);
